...
1. Parse the complete arguments above. If they contain `--minimal` (in any
   position), remove it and remember that minimal mode was requested.
2. Classify all remaining text before choosing a module name. It will be one of:
